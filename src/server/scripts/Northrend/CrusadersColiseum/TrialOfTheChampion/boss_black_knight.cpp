...
public:
    ...
    struct boss_black_knightAI : public ScriptedAI
    {
        ...
        void Reset()
        {
            ...
            uiDeathBiteTimer = urand (3000, 4000);
            uiMarkedDeathTimer = urand (5000, 7000);
			me->SetCorpseDelay(20*MINUTE*IN_MILLISECONDS);
        }
        ...
        void ExplodeAliveGhouls()
        {
            ...
            for (SummonList::iterator itr = summons.begin(); itr != summons.end(); ++itr)
                if (Creature* ghoul = me->GetCreature(*me, *itr))
                    ghoul->CastSpell(ghoul, IsHeroic() ? SPELL_EXPLODE_H : SPELL_EXPLODE);
        }
        ...
        void JustDied(Unit* killer)
        {
            ...
            if (instance)
			{
				...
				killer->SummonGameObject(IsHeroic()? 600000 : 600001, 746.59f, 618.49f, 411.09f, 1.42f, 0, 0, 0, 0, 90000000);
			}
        }
    };
