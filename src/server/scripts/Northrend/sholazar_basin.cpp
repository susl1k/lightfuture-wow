...
{
    "Use the pressure valve!",
    "Heat over hot coals!",
    "Throwing an orange still in it, hurry!",
    "Mix a few bananas!",
    "Quick, a Papaya!",
    "No, that was wrong! We have to start again."
};

#define GOSSIP_ITEM_TIPSY  "I'm ready, let's begin."
                ...
                case EVENT_MISS_BIRD:
                {
                    ...
                    else
                    {
                        ...
                        crunchy->GetMotionMaster()->MovePoint(0, bird->GetPositionX(), bird->GetPositionY(),
                            bird->GetMap()->GetHeight(bird->GetPositionX(), bird->GetPositionY(), bird->GetPositionZ()));
...
public:
    ...
    struct npc_vics_flying_machineAI : public VehicleAI
    {
        ...
        void SpellHit(Unit* /*caster*/, SpellInfo const* spell)
        {
            ...
            {
                Unit* passenger = me->GetVehicleKit()->GetPassenger(0); // player should be on seat 0
