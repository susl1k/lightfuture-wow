...
public:
    ...
    struct instance_obsidian_sanctum_InstanceMapScript : public InstanceScript
    {
        ...
        uint8 m_bTenebronKilled;
        uint8 m_bShadronKilled;
        uint8 m_bVesperonKilled;
        ...
        void Initialize()
        {
			...
			m_bTenebronKilled = SPECIAL;
            m_bShadronKilled = SPECIAL;
            m_bVesperonKilled = SPECIAL;
        }
