...
public:
    ...
    bool OnGossipSelect(Player* player, Creature* creature, uint32 /*uiSender*/, uint32 uiAction)
    {
		...
		if (Creature* gyrocopter = creature->SummonCreature(NPC_GYROCOPTER, *creature))
		{
			...
			hordeWaypoints[0] = Vector3(5841.087891f, 475.734131f, 657.640198f);
			hordeWaypoints[1] = Vector3(5819.568359f, 411.775635f, 681.437988f);
			hordeWaypoints[2] = Vector3(5827.815918f, 361.677979f, 668.690308f);
			hordeWaypoints[3] = Vector3(5879.711914f, 314.450317f, 654.848511f);
			hordeWaypoints[4] = Vector3(5952.648438f, 313.218567f, 644.767761f);
			hordeWaypoints[5] = Vector3(6040.539063f, 361.793915f, 641.533936f);
			hordeWaypoints[6] = Vector3(6339.972168f, 542.130249f, 644.289673f);
			hordeWaypoints[7] = Vector3(6721.421387f, 832.786560f, 657.804932f);
			hordeWaypoints[8] = Vector3(6955.448730f, 1062.298096f, 614.978455f);
			hordeWaypoints[9] = Vector3(7190.628906f, 1169.387451f, 578.993103f);
			hordeWaypoints[10] = Vector3(7301.608887f, 1214.732910f, 574.569763f);
			hordeWaypoints[11] = Vector3(7461.472656f, 1270.433105f, 616.889954f);
			hordeWaypoints[12] = Vector3(7555.871582f, 1336.021606f, 647.024841f);
			hordeWaypoints[13] = Vector3(7590.004395f, 1429.571289f, 658.405823f);
			hordeWaypoints[14] = Vector3(7559.906250f, 1497.666626f, 656.687378f);
			hordeWaypoints[15] = Vector3(7522.950195f, 1513.560303f, 646.460876f);
			hordeWaypoints[16] = Vector3(7490.181641f, 1457.558472f, 642.359314f);
			hordeWaypoints[17] = Vector3(7480.052246f, 1422.484009f, 644.490906f);
			hordeWaypoints[18] = Vector3(7506.947754f, 1400.743774f, 638.465942f);
...
public:
    ...
    bool OnGossipSelect(Player* player, Creature* creature, uint32 /*uiSender*/, uint32 uiAction)
    {
		...
		if (Creature* gyrocopter = creature->SummonCreature(NPC_GYROCOPTER, *creature))
		{
			...
			allianceWaypoints[0] = Vector3(5841.087891f, 475.734131f, 657.640198f);
			allianceWaypoints[1] = Vector3(5819.568359f, 411.775635f, 681.437988f);
			allianceWaypoints[2] = Vector3(5827.815918f, 361.677979f, 668.690308f);
			allianceWaypoints[3] = Vector3(5879.711914f, 314.450317f, 654.848511f);
			allianceWaypoints[4] = Vector3(5952.648438f, 313.218567f, 644.767761f);
			allianceWaypoints[5] = Vector3(6040.539063f, 361.793915f, 641.533936f);
			allianceWaypoints[6] = Vector3(6339.972168f, 542.130249f, 644.289673f);
			allianceWaypoints[7] = Vector3(6721.421387f, 832.786560f, 657.804932f);
			allianceWaypoints[8] = Vector3(6955.448730f, 1062.298096f, 614.978455f);
			allianceWaypoints[9] = Vector3(7190.628906f, 1169.387451f, 578.993103f);
			allianceWaypoints[10] = Vector3(7242.176758f, 1215.623779f, 576.078247f);
			allianceWaypoints[11] = Vector3(7315.382813f, 1290.768188f, 573.536377f);
			allianceWaypoints[12] = Vector3(7405.139648f, 1397.881958f, 574.835266f);
			allianceWaypoints[13] = Vector3(7466.253906f, 1482.482666f, 586.226746f);
			allianceWaypoints[14] = Vector3(7537.151855f, 1601.269165f, 605.752869f);
			allianceWaypoints[15] = Vector3(7582.723145f, 1733.833130f, 629.017273f);
			allianceWaypoints[16] = Vector3(7593.963379f, 1803.280396f, 644.811951f);
			allianceWaypoints[17] = Vector3(7556.053223f, 1876.133545f, 665.037781f);
			allianceWaypoints[18] = Vector3(7518.908691f, 1887.642822f, 672.107361f);
			allianceWaypoints[19] = Vector3(7484.753906f, 1882.426270f, 675.867310f);
			allianceWaypoints[20] = Vector3(7471.553711f, 1877.463745f, 676.562439f);
			allianceWaypoints[21] = Vector3(7456.784668f, 1821.872192f, 677.968445f);
			allianceWaypoints[22] = Vector3(7470.592773f, 1794.067383f, 666.910767f);
			allianceWaypoints[23] = Vector3(7474.917480f, 1788.022461f, 665.640503f);
