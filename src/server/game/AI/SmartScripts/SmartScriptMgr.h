...
enum SMART_EVENT
{
    ...
    SMART_EVENT_TARGET_CASTING           = 13,      //1             // RepeatMin, RepeatMax, spellid
    ...
    SMART_EVENT_ACTION_DONE              = 72,      //1             // eventId (SharedDefines.EventId)
    SMART_EVENT_ON_SPELLCLICK            = 73,      //1             // clicker (unit)
    SMART_EVENT_FRIENDLY_HEALTH_PCT      = 74,      //1             // minHpPct, maxHpPct, repeatMin, repeatMax
...
enum SMART_ACTION
{
	...
	SMART_ACTION_SUMMON_CREATURE_GROUP              = 107,    // groupId
