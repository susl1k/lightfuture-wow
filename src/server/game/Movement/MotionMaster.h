...
class MotionMaster //: private std::stack<MovementGenerator *>
{
    ...
    public:
        ...
        void MoveSmoothPath(uint32 id, const Movement::PointsArray &points, float velocity, bool fly);
		void MoveSmoothPath(uint32 id, const Position points[], uint32 pointsCount, float velocity, bool fly);
		void MoveSmoothPath(uint32 id, uint32 npc_id, float velocity, bool fly);
